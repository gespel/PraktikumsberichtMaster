...
\end{minted}
Die \texttt{doca\_flow\_remove\_entry()} ist allerdings neu und erlaubt unter der Angabe der Pipe-Queue und des Entry auch analog zum Hinzufügen das Löschen eines Entries aus einer Pipe.
\subsubsection*{Ergebnisse}
\begin{figure}
    \centering
